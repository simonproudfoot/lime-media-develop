<a :href="show.link" class="card">
    <div class="card__imageWrap rounded-lg overflow-hidden bg-grey bg-brandgrey">
        <img :src="show._embedded['wp:featuredmedia'][0].media_details.sizes.medium_large.source_url" alt="<?php the_post_thumbnail_caption() ?>" class="w-full object-cover aspect-video" />
    </div>
